...
.directive('stripeForm', ['$window', '$parse', 'Common', function($window, $parse, Common) {
  ...
  // directive intercepts form-submission, obtains Stripe's cardToken using stripeController.js
  ...
  return {
    ...
    link: function(scope, elem, attr) {
      ...
      if(!$window.Stripe){
          throw 'stripeForm requires that you have stripeController.js installed. Include https://js.stripe.com/v2/ into your html.';
      }
